...
function SideNavWrapper({ ariaLabel, children }: SideNavWrapperProps) {
  return (
    <nav
      ...
      className={`sideNavWrapper bg-white flex flex-row w-full fixed bottom-0 left-0 mdTablet:top-0 mdTablet:h-screen mdTablet:w-20 border-t mdTablet:border-none border-ebony-clay mdTablet:translate-x-0 z-30 dark:bg-black dark:text-white`}
    >
