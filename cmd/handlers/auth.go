...
func (h *Handlers) HandleGoogleSignIn(response http.ResponseWriter, request *http.Request) {
...
func (h *Handlers) HandleGoogleCallback(response http.ResponseWriter, request *http.Request) {
	h.logger.Info("Handling Google OAuth callback")
...
// Verify JWT Token
func (h *Handlers) HandleVerifyToken(response http.ResponseWriter, request *http.Request) {
	cookie, err := request.Cookie("token")
	if err != nil {
    h.logger.Error("Error: No token cookie", "error", err)
...
// Refresh Token
func (h *Handlers) HandleRefreshToken(response http.ResponseWriter, request *http.Request) {
...
func (h *Handlers) HandleSignOut(response http.ResponseWriter, request *http.Request) {
	// Clear token cookie
	http.SetCookie(response, &http.Cookie{
		Name:     "token",
		Value:    "",
