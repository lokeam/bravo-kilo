...
func (r *BookRepositoryImpl) AddFormats(tx *sql.Tx, ctx context.Context, bookID int, formatTypes []string) error {
...
func (r *BookRepositoryImpl) GetAllBooksByFormat(userID int) (map[string][]Book, error) {
...
func (r *BookRepositoryImpl) GetOrInsertFormat(ctx context.Context, formatType string) (int, error) {
	var formatID int
